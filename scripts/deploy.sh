...
build() {
    docker build -f ./docker/Dockerfile -t "192.168.1.15:5000/chunk-destroyer:${VERSION}" .
}

push() {
    docker push "192.168.1.15:5000/chunk-destroyer:${VERSION}"
}
